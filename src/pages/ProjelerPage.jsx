...
const PROJECTS = [
  {
    id: 'kafe-neon-tabela',
    title: 'Kafe Neon Tabela Tasarımı',
    description: 'Cafe atmosferini tamamlayan el yapımı gerçek neon tüp tabela. Özel yazı tipi ve renk seçimi ile müşteriye özgü üretim.',
    category: 'Cafe & Restoran',
    accent: '#00e5ff',
    icon: '🍹',
    src: '/images/kafe-neon-tabela-1..jpeg',
    alt: 'kafe neon tabela tasarımı gerçek neon tüp özel üretim',
    productHref: '/urun/kafe-neon-tabela',
  },
  {
    id: 'kafe-neon-tabela-2',
    title: 'Kafe Yazı Neon Tabela',
    description: 'Minimalist cafe konseptine uygun, sıcak beyaz neon tüp ile hazırlanmış özel yazı tabelası.',
    category: 'Cafe & Restoran',
    accent: '#00e5ff',
    icon: '☕',
    src: '/images/kafe-neon-tabela-2.jpeg',
    alt: 'kafe neon yazı tabelası minimalist tasarım gerçek neon',
    productHref: '/urun/kafe-neon-tabela',
  },
  {
  ...
  {
    id: 'is-yeri-neon-tabelasi-3',
    title: 'İşletme Neon Reklam',
    description: 'Yüksek görünürlük sağlayan dış cephe neon reklam tabelası. IP65 su geçirmez yapı, tüm hava koşullarına uygun.',
    category: 'Mağaza & Ofis',
    accent: '#ff2d78',
    icon: '📋',
    src: '/images/is-yeri-neon-tabelasi-3.jpeg',
    alt: 'işletme neon reklam tabelası dış cephe su geçirmez',
    productHref: '/urun/is-yeri-neon-tabelasi',
  },
  {
  ...
  {
    id: 'dukkan-reklam-tabelasi-3',
    title: 'Özel Reklam Neon',
    description: 'Marka logosunu neon ışıkla hayata geçiren özel üretim reklam tabelası. 7/24 kesintisiz kullanım.',
    category: 'Dükkan & Reklam',
    accent: '#00e5ff',
    icon: '✨',
    src: '/images/dukkan-reklam-tabelasi-3.jpeg',
    alt: 'özel reklam neon tabela marka logo 7/24 kullanım',
    productHref: '/urun/ozel-neon-logo',
  },
  {
    id: 'dukkan-reklam-tabelasi-4',
    title: 'Neon Tabela Örneği',
    description: 'Farklı renk ve yazı tipi seçenekleriyle kişiselleştirilebilen neon tabela projesi.',
    category: 'Dükkan & Reklam',
    accent: '#00e5ff',
    icon: '🔆',
    src: '/images/dukkan-reklam-tabelasi-4.jpeg',
    alt: 'neon tabela örneği kişiselleştirilebilir renk yazı tipi',
    productHref: '/urun/ozel-neon-logo',
  },
  {
