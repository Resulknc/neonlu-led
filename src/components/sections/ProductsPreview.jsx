...
/**
 * Home page preview — shows 4 featured products with real photos.
 * Full catalogue is at /urunler.
 */

const FEATURED_SLUGS = [
  'is-yeri-neon-tabelasi',
  'dugun-neon-tabelasi',
  'ev-dekor-neon-tabela',
  'dukkan-reklam-tabelasi',
]
...
function ProductImage({ product }) {
  ...
  const dim    = product.color === 'pink' ? 'rgba(255,45,120,0.07)' : 'rgba(0,229,255,0.07)'
  ...
  if (product.image && !failed) {
    return (
      <div
        ...
        style={{ height: 160, borderBottom: `1px solid ${accent}25` }}
      >
        <img
          src={product.image}
          alt={`${product.title} örneği`}
          loading="lazy"
        ...
        <div
          ...
          style={{ background: `linear-gradient(to top, #0a0a0a 0%, transparent 50%, transparent 100%)` }}
        />
      </div>
    )
  }
